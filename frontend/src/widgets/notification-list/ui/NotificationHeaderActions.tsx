  ...
  if (state.isEditMode) {
    return (
      <div className="flex items-center gap-2">
        <span className="typo-xs-sb text-foreground">
        ...
        <button
          ...
          className="rounded-full border border-destructive px-3 py-1 typo-xs-sb text-destructive disabled:opacity-40"
        >
        ...
        <button
          ...
          className="typo-xs-sb text-grey-300"
        >
          취소
        </button>
      </div>
  ...
  return (
    <div className="flex items-center gap-1">
      <button
        ...
        className="flex items-center gap-1.5 rounded-full px-3 py-1.5 typo-xs-sb text-grey-300 transition-colors hover:text-foreground"
